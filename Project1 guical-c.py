from tkinter import *   #expression variable 
...
def press(num): 
    ...
    equation.set(expression)      #set method 
...
def equalpress(): 
    ...
    try:  # for handling the errors like zero                    
    ...
    # if error is generate then handle by except block 
